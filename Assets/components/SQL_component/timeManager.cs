...
public class timeManager : MonoBehaviour
{
    ...
    public void Start()
    {
        timetillnextgame =GameObject.FindObjectOfType<SQL_manager>().timeForNextGame().AddSeconds(-8);//this.GetComponent<SQL_manager>().timeTillNextGame().Subtract(DateTime.Now);
